            ...
            <form action="user_act.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <input type="text" class="form-control" name="regional" placeholder="Khusus Memilih Level Regional ..">
                <p>Kosongkan Jika tidak ingin di isi (khusus untuk level regional)</p>
              </div>
               <div class="form-group">
                <label>KPRK</label>
                <input type="text" class="form-control" name="KPRK" placeholder="Khusus Memilih Level KPRK ..">
                 <p>Kosongkan Jika tidak ingin di isi (khusus untuk level KPRK)</p>
              </div>
              <div class="form-group">
                <label>Foto</label>
