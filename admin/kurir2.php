...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Kurir
      <small>Pengiriman Luar Negeri</small>
    </h1>
    <ol class="breadcrumb">
      ...
      <section class="col-lg-12 col-lg-offset-0">       
        <div class="box box-info">
          ...
          <div class="box-header">
            <h3 class="box-title">Pengiriman Luar Negeri</h3>
            <a href="kurir.php" class="btn btn-info btn-sm pull-right"><i class="fa fa-reply"></i> &nbsp Kembali</a> 
          </div>
          <div class="box-body">
            <form action="kurir2_act.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group" >
                ...
                <select class="form-control" name="kiriman_negara" required="required">
				  <option value="">-- Pilih Negara --</option>
                  <?php
				   $qdata = mysqli_query($koneksi, "select * from ref_negara order by nama_negara");
				   while($k = mysqli_fetch_array($qdata)){
                        ?>
                        <option value="<?php return $k['id_negara']?>"><?php return $k['nama_negara']; ?></option>
                        <?php 
                   }
                   ?>
              ...
              <div class="form-group" >
                ...
                <select class="form-control" name="tarif_jenis" required="required">
                  ...
                  <?php
				   $qdata = mysqli_query($koneksi, "select * from tarif_paket where jenis=2 order by nama");
				   while($k = mysqli_fetch_array($qdata)){
                        ?>
