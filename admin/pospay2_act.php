...
if($saldo>$total){
	...
	values('$id', 2, '$jenisproduk', '$tanggal','$nohp', $jumlah, '$admin', '$total', '$noref')");
	...
	header("location:pospay2.php?alert=ok&id_pospay=".$id_insert);
} else {
    header("location:pospay2.php?alert=gagal");	
}